...
static int cmd_gpio_mode(int argc, const console_cmd_args *argv) {
  if (argc != 3) {
...
static int cmd_gpio_write(int argc, const console_cmd_args *argv) {
  if (argc != 3) {
...
static int cmd_gpio_test(int argc, const console_cmd_args *argv) {
